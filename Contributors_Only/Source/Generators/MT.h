...
#define N_PARAMETER 312
#define M_PARAMETER 156
...
namespace DiceForge{
    ...
    class MT
    {
        ...
        const int N = N_PARAMETER; // length of state value vector
        const int M = M_PARAMETER; // optimum value as mid
